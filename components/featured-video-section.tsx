        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative bg-white rounded-2xl md:rounded-3xl shadow-2xl overflow-hidden border-4 border-white">
            {isPlaying && videoSrc ? (
              ...
              <div
                className="w-full aspect-video bg-gradient-to-br from-[#FFF8E7] via-[#FFE4CC] to-[#FFF0DB] flex flex-col items-center justify-center relative group cursor-pointer"
                onClick={() => setIsPlaying(true)}
              >
                {/* Professor Panda thumbnail */}
                <div className="absolute inset-0">
                  <Image
                    src="/images/featured-video-thumbnail.jpg"
